...
static GNW_LANG GNW_LANG_CHS[] =
{
	...
	{"Battery Chemistry", "电池化学成分"},
	{"Battery Life Full", "满电运行时间"},
	{"Battery Life Percentage", "电池剩余电量"},
	{"Battery Life Remaining", "电池剩余时间"},
	{"Battery Status", "电池状态"},
	{"Bits per color", "位/颜色"},
	{"Boot Device", "启动设备"},
	{"Boot Indicator", "可启动指示"},
	{"Brand", "品牌"},
	...
	{"Item", "项目"},
	{"L1 D", "L1 数据"},
	{"L1 Data Cache Instances", "L1 数据缓存实例"},
	{"L1 I", "L1 指令"},
	{"L1 Instruction Cache Instances", "L1 指令缓存实例"},
	{"L2 Cache Instances", "L2 缓存实例"},
	{"L3 Cache Instances", "L3 缓存实例"},
	{"L4 Cache Instances", "L4 缓存实例"},
	{"Label", "卷标"},
	{"Language ID", "语言 ID"},
	{"Length", "长度"},
	{"Location", "位置"},
