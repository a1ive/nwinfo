...
lang_tr_tr[N__MAX_] =
{
	...
	[N__MAINBOARD] = u8"Anakart",
	[N__CHIPSET] = u8"Yonga seti",
	[N__NAME] = u8"Ad",
	//[N__UUID],
	//[N__LPCIO],
	//[N__TPM],
	[N__ALGORITHMS] = u8"Algoritmalar",
	...
	[N__NO_QUICK_ACCESS] = u8"Hızlı erişim düğmesini devre dışı bırak",
	...
	[N__FONT_NAME] = u8"Yazı Tipi",
	[N__FONT_SIZE] = u8"Yazı tipi boyutu",
