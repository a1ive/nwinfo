...
const char* DMI_VENDOR_NAME[VENDOR__MAX] =
{
	[VENDOR_UNKNOWN] = NULL,
	[VENDOR_ACER] = "Acer",
	[VENDOR_AMD] = "AMD",
...
#else
extern const char* DMI_VENDOR_NAME[VENDOR__MAX];
#endif
...
#ifdef MB_VENDOR_IMPL
const struct DMI_VENDOR_ENTRY DMI_VENDOR_LIST[] =
{
...
#else
extern const struct DMI_VENDOR_ENTRY DMI_VENDOR_LIST[];
#endif
